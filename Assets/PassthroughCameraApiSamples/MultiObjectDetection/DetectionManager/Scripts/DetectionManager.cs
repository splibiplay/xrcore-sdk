...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class DetectionManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Ejecuta la misma acción que el botón A (generar marcadores 3D de los objetos detectados).
        /// </summary>
        public void TriggerActionA()
        {
            if (m_isStarted)
            {
                SpawnCurrentDetectedObjects();
        ...
        /// <summary>
        /// Ejecuta la misma acción que el botón B (limpiar todos los marcadores).
        /// </summary>
        public void TriggerActionB()
        {
            CleanMarkers();
        }
