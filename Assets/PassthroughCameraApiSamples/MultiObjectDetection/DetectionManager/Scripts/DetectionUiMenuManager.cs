...
namespace PassthroughCameraSamples.MultiObjectDetection
{
    ...
    public class DetectionUiMenuManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Llamado desde UI (ej. botón A / UIInputBridge) para cerrar el menú "Press A to start"
        /// y comenzar la detección. Si ya estamos en modo detección, no hace nada.
        /// </summary>
        public void NotifyActionAPressed()
        {
            if (m_initialMenu)
            {
                m_buttonSound?.Play();
